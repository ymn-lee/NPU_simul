...
//     // bool is_copy = false;
//     // if(tile->core_id!=cnt) is_copy=true;
...
void GemmWS::initialize_instructions(Tile* tile, Mapping mapping) {
  ...
  int total_tiles = mapping.tile_out_loop.N * mapping.tile_out_loop.M * mapping.tile_out_loop.C;
  int tile_idx = tile->batch * mapping.tile_out_loop.M * mapping.tile_out_loop.C + tile->M * mapping.tile_out_loop.C + tile->C;
